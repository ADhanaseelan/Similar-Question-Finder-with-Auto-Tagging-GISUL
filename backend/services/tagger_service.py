...
TOPIC_SEEDS = {
    ...
    # Core Engineering (Indian Universities / B.Tech)
    'DSA':              'data structures algorithms sorting searching trees graphs dynamic programming linked list',
    'DBMS':             'database SQL normalization transactions relational schema oracle mysql nosql mongodb',
    'Operating Systems':'processes threads memory management file systems scheduling linux windows unix',
    'Computer Networks':'TCP IP protocols routing HTTP DNS network layers OSI model switching',
    'Java':             'Java OOP inheritance polymorphism JVM Spring Boot hibernate servlet',
    'Python':           'Python lists dictionaries functions classes decorators pandas numpy django flask',
    'Machine Learning': 'neural networks deep learning classification regression clustering NLP AI tensorflow pytorch',
