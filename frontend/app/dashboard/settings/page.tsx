  ...
  return (
    <div className="flex flex-col items-center justify-center h-[70vh] text-center">
      <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 max-w-md">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Platform Settings</h1>
        <p className="text-gray-500 mb-6">This feature is currently under development. Account configuration and theming options are coming soon.</p>
