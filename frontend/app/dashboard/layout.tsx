  ...
  return (
    <div className="flex min-h-screen bg-background-light dark:bg-background-dark font-sans">
      ...
      <div className="flex-1 ml-0 md:ml-64 flex flex-col min-h-screen overflow-hidden">
        {/* Header */}
        <header className="h-20 bg-white/60 backdrop-blur-md flex items-center justify-between px-4 md:px-10 shrink-0 sticky top-0 z-20 shadow-sm border-b border-gray-100">
