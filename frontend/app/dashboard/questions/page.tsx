"use client";
import { MessageSquare, Clock, Tag, Search, Loader2 } from "lucide-react";
  ...
  return (
    <div className="pb-12 space-y-8 max-w-5xl mx-auto">
      <div className="mb-6 md:mb-8 text-center px-4">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-800 tracking-tight">My Questions</h1>
        <p className="text-gray-500 mt-2 text-base md:text-lg max-w-2xl mx-auto">
          Review all the questions you've asked the AI platform.
        </p>
      </div>
